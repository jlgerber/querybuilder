...
var Relation = Enum("is","like"); // may decide to differentiate between is and in some day...seriali
 ...
 * */
/*
var component = Component.create("department",Relation.is, "model");

console.log(component.toString());
component.value=["model","anim"];
console.log(component.toString());
component.relation = Relation.like;
console.log(component.toString());

var group =  Statement.create(Component.create("department", Relation.is, "anim"), Component.create("subcontext", Relation.is, ["hi","md"]));
var group2 = Statement.create(Component.create("department",Relation.is,"integ"), Component.create("name", Relation.like, "cam"));
console.log(group.toString());
console.log(group2.toString());

var compound = new Compound(group, Operator.or, group2);
console.log(compound.toString());
console.log(JSON.stringify(compound));
var c2 = JSON.parse(JSON.stringify(compound));
console.log(c2);
console.log("lhs",c2.lhs);

var c3 = Compound.fromOL(c2);

console.log(c3.toString());
console.log(JSON.stringify(c3));*/
//console.log(s.serialize(compound));
//var c2 = s.deserialize(s.serialize(compound));
